...
The only existing scoped `CLAUDE.md` is `receiving end/fbb_ws63/ci/CLAUDE.md`; follow it for CI-gate-specific changes.
...
- For CI gate work, use `receiving end/fbb_ws63/ci/CLAUDE.md` rather than duplicating its rules here.
